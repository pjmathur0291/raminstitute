      ...
      <div className="container-x py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <p className="text-sm text-white/80 leading-relaxed">
            India's leading hotel management institute, crafting world-class hospitality leaders for over two decades.
            97% placement at Taj, Oberoi, ITC and global hospitality chains.
          </p>
          <div className="flex gap-3 mt-5">
            <a
              href="#"
              className="w-9 h-9 rounded-sm bg-white/10 hover:bg-gold-500 hover:text-burgundy-700 flex items-center justify-center transition-colors"
              aria-label="Facebook"
            >
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/80">
            ...
            <li>
              <Link to="/courses/diploma-in-hotel-management" className="hover:text-gold-300">
            ...
            <li>
              <Link to="/courses/diploma-in-bartending" className="hover:text-gold-300">
                Bartending & Mixology
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/80">
            ...
            <li>
              <Link to="/placements" className="hover:text-gold-300">
                Placements
              </Link>
            </li>
            <li>
              <Link to="/scholarships" className="hover:text-gold-300">
                Scholarships
              </Link>
            </li>
            <li>
              <Link to="/campus-life" className="hover:text-gold-300">
                Campus Life
              </Link>
            </li>
            <li>
              <Link to="/gallery" className="hover:text-gold-300">
                Gallery
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/85">
            <li className="flex gap-2.5">
              <MapPin className="w-4 h-4 flex-shrink-0 mt-0.5 text-gold-400" /> <span>{SITE.address}</span>
            </li>
            <li className="flex gap-2.5">
              <Phone className="w-4 h-4 flex-shrink-0 mt-0.5 text-gold-400" />
              {phoneNumbers.map((phone, index) => (
                <a key={index} href={`tel:${phone}`} data-testid={`nav-call-${index}`} className="hover:text-gold-300">
                  {phone}
                  {index < phoneNumbers.length - 1 && <span className="">,</span>}
                </a>
              ))}{' '}
            </li>
            <li className="flex gap-2.5">
              <Mail className="w-4 h-4 flex-shrink-0 mt-0.5 text-gold-400" />{' '}
          ...
          <form onSubmit={onFooterSubmit} className="mt-5 space-y-2" data-testid="footer-lead-form">
            ...
            <input
              ...
              className="w-full h-9 px-3 rounded-sm bg-white/10 border border-white/20 text-white placeholder-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-gold-500"
            ...
            <button
              ...
              className="w-full h-9 bg-gold-500 hover:bg-gold-600 text-burgundy-900 font-semibold rounded-sm text-sm transition-all disabled:opacity-60"
      ...
      <div className="border-t border-white/10">
        <div className="container-x py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-white/60">
          ...
          <p className="flex gap-4">
            ...
            <Link to="/admin/login" className="hover:text-gold-300">
              Admin
            </Link>
          </p>
        </div>
