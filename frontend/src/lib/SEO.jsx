...
export default function SEO({
  title = 'Best Hotel Management College in Dehradun | Shri Ram Institute',
  description = 'Join Ram Institute, a leading hotel management college in Dehradun. Explore industry-focused courses, expert faculty, practical training, and strong placement support.',
  canonical,
